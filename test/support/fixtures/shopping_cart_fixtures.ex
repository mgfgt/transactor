defmodule Transactor.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Transactor.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Transactor.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Transactor.ShoppingCart.create_cart_item()
