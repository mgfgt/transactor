defmodule Transactor.CatalogTest do
  use Transactor.DataCase

  alias Transactor.Catalog

  describe "products" do
    alias Transactor.Catalog.Product

    import Transactor.CatalogFixtures
  ...
  describe "categories" do
    alias Transactor.Catalog.Category
