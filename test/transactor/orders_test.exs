defmodule Transactor.OrdersTest do
  use Transactor.DataCase

  alias Transactor.Orders

  describe "orders" do
    alias Transactor.Orders.Order

    import Transactor.OrdersFixtures
  ...
  describe "order_line_items" do
    alias Transactor.Orders.LineItem
