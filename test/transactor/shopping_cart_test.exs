defmodule Transactor.ShoppingCartTest do
  use Transactor.DataCase

  alias Transactor.ShoppingCart

  describe "carts" do
    alias Transactor.ShoppingCart.Cart

    import Transactor.ShoppingCartFixtures
  ...
  describe "cart_items" do
    alias Transactor.ShoppingCart.CartItem
